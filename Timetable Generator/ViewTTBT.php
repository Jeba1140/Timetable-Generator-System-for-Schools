...
<html >
<head>
	<title>View timetable by teacher</title>
...
if(isset($_SESSION["AdminID"]))
{
   ...
   {
	   $sql = "SELECT Name FROM teacher WHERE ID=".$_SESSION["TeacherID2"];
	   $result=mysqli_query($conn, $sql);
	   $row=mysqli_fetch_array($result);
	   $teacherName=$row['Name'];
	   
	   $sql1 = "SELECT * FROM timetable WHERE Timeslot='A1' and  TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql2 = "SELECT * FROM timetable WHERE Timeslot='B1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql3 = "SELECT * FROM timetable WHERE Timeslot='C1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql4 = "SELECT * FROM timetable WHERE Timeslot='D1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql5 = "SELECT * FROM timetable WHERE Timeslot='E1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql6 = "SELECT * FROM timetable WHERE Timeslot='F1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql7 = "SELECT * FROM timetable WHERE Timeslot='G1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql8 = "SELECT * FROM timetable WHERE Timeslot='H1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql9 = "SELECT * FROM timetable WHERE Timeslot='I1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql10 = "SELECT * FROM timetable WHERE Timeslot='J1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql11 = "SELECT * FROM timetable WHERE Timeslot='K1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql12 = "SELECT * FROM timetable WHERE Timeslot='L1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql13 = "SELECT * FROM timetable WHERE Timeslot='M1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql14 = "SELECT * FROM timetable WHERE Timeslot='N1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql15 = "SELECT * FROM timetable WHERE Timeslot='O1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql16 = "SELECT * FROM timetable WHERE Timeslot='P1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql17 = "SELECT * FROM timetable WHERE Timeslot='Q1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql18 = "SELECT * FROM timetable WHERE Timeslot='R1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql19 = "SELECT * FROM timetable WHERE Timeslot='S1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql20 = "SELECT * FROM timetable WHERE Timeslot='T1' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql21 = "SELECT * FROM timetable WHERE Timeslot='A2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql22 = "SELECT * FROM timetable WHERE Timeslot='B2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql23 = "SELECT * FROM timetable WHERE Timeslot='C2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql24 = "SELECT * FROM timetable WHERE Timeslot='D2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql25 = "SELECT * FROM timetable WHERE Timeslot='E2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql26 = "SELECT * FROM timetable WHERE Timeslot='F2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql27 = "SELECT * FROM timetable WHERE Timeslot='G2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql28 = "SELECT * FROM timetable WHERE Timeslot='H2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql29 = "SELECT * FROM timetable WHERE Timeslot='I2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql30 = "SELECT * FROM timetable WHERE Timeslot='J2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql31 = "SELECT * FROM timetable WHERE Timeslot='K2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql32 = "SELECT * FROM timetable WHERE Timeslot='L2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql33 = "SELECT * FROM timetable WHERE Timeslot='M2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql34 = "SELECT * FROM timetable WHERE Timeslot='N2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql35 = "SELECT * FROM timetable WHERE Timeslot='O2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql36 = "SELECT * FROM timetable WHERE Timeslot='P2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql37 = "SELECT * FROM timetable WHERE Timeslot='Q2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql38 = "SELECT * FROM timetable WHERE Timeslot='R2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql39 = "SELECT * FROM timetable WHERE Timeslot='S2' and TeacherID=".$_SESSION["TeacherID2"];
	   ...
	   $sql40 = "SELECT * FROM timetable WHERE Timeslot='T2' and TeacherID=".$_SESSION["TeacherID2"];
...
<div class="grad"></div>
	...
	<div class="Table" style="height:95%;">
		<ul>
		...
		<span id="span1"><center><u>Time table for teacher:<?php echo $teacherName."(".$_SESSION["TeacherID2"].")";?> </u></center></span><br>
		<center>
			   <table id="tabColor">
			     <tr><th> </th>
					 <th>8.00-8.50</th>
